...
/**
 * @covers \App\Entity\Notification\UserMentionedInPostNotification
 * Class UserMentionedInPostNotificationTest
 * @package App\Tests\unit\Entity\Notification
 */
class UserMentionedInPostNotificationTest extends Unit
{
	/**
	 * @throws Exception
	 */
