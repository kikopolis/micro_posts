 ...
 */
class ForcePasswordChange extends AbstractController
{
	...
	/**
	 * ForcedPasswordChange constructor.
	 ...
	 *     name="admin.user.force.password.change",
	 *     methods={"POST"}
	 * )
	 * @param  int  $id
	 * @return Response
	...
	public function __invoke(int $id): Response
	{
		...
		$this->eventDispatcher->dispatch(
			new ForcedPasswordChangeEvent($user)
		);
